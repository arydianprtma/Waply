...
export default function AdminTicketDetailPage() {
  ...
  const handleSendReply = async (e?: React.FormEvent) => {
    ...
    if ((!msg && pendingAttachments.length === 0) || !ticket) return;
    ...
    const tempMsg: any = {
      ...
      senderRole: "admin",
      message: msg || (attachmentsToSend.length > 0 ? `[Mengirim ${attachmentsToSend.length} lampiran file]` : ""),
              ...
              return (
                ...
                >
                  ...
                  <div className="space-y-1">
                    ...
                    >
                      <ChatMessageContent content={msg.message} attachments={msg.attachments} isUser={isAdmin} />
                    </div>
                  </div>
                </div>
              );
            ...
            {ticket.status === "RESOLVED" || ticket.status === "CLOSED" ? (
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <button
                    type="submit"
                    disabled={(!replyMessage.trim() && pendingAttachments.length === 0) || sendingReply || uploadingAttachment}
